          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="max-w-xl">
              ...
              <div className="space-y-6 font-body text-base text-secondary leading-relaxed">
                ...
                <p className="border-l-4 border-accent pl-6 py-2 mt-8 text-primary font-semibold text-lg italic">
                  "Every landscape tells a unique story; our passion is to bring that
                  story to life. We are committed to understanding and exceeding our client's expectations."
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="section-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            {values.map((val) => (
              <div
                key={val.title}
                className="bg-white p-8 md:p-10 rounded-2xl shadow-soft hover:shadow-card-hover transition-all duration-300 border border-border"
              >
